...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		appUserRepository.save(new AppUser("user","$2a$12$w5oTWFGZEtb/0flU6CMEaOoouEbqGvnsK/8BP353edj9KNJbUCWxW","User"));
		appUserRepository.save(new AppUser("admin","$2a$12$AY6UDFFvf7z2a8XyVRM4yOzlxv/i5NGeRVvN9n4CvhXf6QofOA4Xa","ADMIN"));
	}
}
